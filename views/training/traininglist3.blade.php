            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('training3/save') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">Brief description on the company's job prospectus</label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">Description of tasks/assignments</label>
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="bg-white p-3">
                    <strong>Date:</strong> {{ $training->start_date }} <br>
                    <strong>Name:</strong> {{ $training->trainer }} <br>
                    <strong>Brief description:</strong> {{ $training->training_type }} <br>
                    <strong>Description of tasks:</strong> {{ $training->today_task }} <br>
                </div>
        ...
        <div id="edit_training" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('training3/update') }}" method="POST">
                            @csrf
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-btn delete-action">
                            <form action="{{ route('training3/delete') }}" method="POST">
                                @csrf
...
<script>
    $(document).ready(function () {
        ...
        $('#exportPdf').on('click', function () {
            ...
            $.ajax({
                url: '{{ route("training3/pdf") }}', // Change this to your Laravel route
                type: 'GET',
