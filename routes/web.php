...
// ----------------------------- training2  ------------------------------//
Route::get('training2/list2/page', [App\Http\Controllers\TrainingController2::class, 'index'])->middleware('auth')->name('training/list2/page');
Route::post('training2/save', [App\Http\Controllers\TrainingController2::class, 'addNewTraining'])->middleware('auth')->name('training2/save');
Route::post('training2/delete', [App\Http\Controllers\TrainingController2::class, 'deleteTraining'])->middleware('auth')->name('training2/delete');
Route::post('training2/update', [App\Http\Controllers\TrainingController2::class, 'updateTraining'])->middleware('auth')->name('training2/update');
Route::get('training2/pdf', [App\Http\Controllers\TrainingController2::class, 'exportPdf'])->middleware('auth')->name('training2/pdf');

// ----------------------------- training3  ------------------------------//
Route::get('training3/list3/page', [App\Http\Controllers\TrainingController3::class, 'index'])->middleware('auth')->name('training/list3/page');
Route::post('training3/save', [App\Http\Controllers\TrainingController3::class, 'addNewTraining'])->middleware('auth')->name('training3/save');
Route::post('training3/delete', [App\Http\Controllers\TrainingController3::class, 'deleteTraining'])->middleware('auth')->name('training3/delete');
Route::post('training3/update', [App\Http\Controllers\TrainingController3::class, 'updateTraining'])->middleware('auth')->name('training3/update');
Route::get('training3/pdf', [App\Http\Controllers\TrainingController3::class, 'exportPdf'])->middleware('auth')->name('training3/pdf');

// ----------------------------- training4  ------------------------------//
Route::get('training4/list4/page', [App\Http\Controllers\TrainingController4::class, 'index'])->middleware('auth')->name('training/list4/page');
Route::post('training4/save', [App\Http\Controllers\TrainingController4::class, 'addNewTraining'])->middleware('auth')->name('training4/save');
Route::post('training4/delete', [App\Http\Controllers\TrainingController4::class, 'deleteTraining'])->middleware('auth')->name('training4/delete');
Route::post('training4/update', [App\Http\Controllers\TrainingController4::class, 'updateTraining'])->middleware('auth')->name('training4/update');
Route::get('training4/pdf', [App\Http\Controllers\TrainingController4::class, 'exportPdf'])->middleware('auth')->name('training4/pdf');
...
Route::get('/notes', [NotesController::class, 'showNotes'])->name('notes');
